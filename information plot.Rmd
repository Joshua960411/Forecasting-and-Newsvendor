...
```{r es}
x_axis<-c(40,120,480,1200,4800)
y_40<-c(mean(sapply(re_40[[1]], "[[", 1)),mean(sapply(re_40[[4]], "[[", 1)),
        mean(sapply(re_40[[7]], "[[", 1)))
y_120<-c(mean(sapply(re_120[[1]], "[[", 1)),mean(sapply(re_120[[4]], "[[", 1)),
        mean(sapply(re_120[[7]], "[[", 1)))
y_480<-c(mean(sapply(re_480[[1]], "[[", 1)),mean(sapply(re_480[[4]], "[[", 1)),
        mean(sapply(re_480[[7]], "[[", 1)))
y_1200<-c(mean(sapply(re_1200[[1]], "[[", 1)),mean(sapply(re_1200[[4]], "[[", 1)),
        mean(sapply(re_1200[[7]], "[[", 1)))
y_4800<-c(mean(sapply(re_4800[[1]], "[[", 1)),mean(sapply(re_4800[[4]], "[[", 1)),
        mean(sapply(re_4800[[7]], "[[", 1)))
y_axis<-c(y_40,y_120,y_480,y_1200,y_4800)
mac<-matrix(y_axis,nrow = 3,ncol = 5)
mac<-t(mac)
rownames(mac)<-c('40','120','480','1200','4800')
colnames(mac)<-c("DGP", "DJ","CF")
mac
v_40<-c(sd(sapply(re_40[[1]], "[[", 1)),sd(sapply(re_40[[4]], "[[", 1)),
        sd(sapply(re_40[[7]], "[[", 1)))
v_120<-c(sd(sapply(re_120[[1]], "[[", 1)),sd(sapply(re_120[[4]], "[[", 1)),
        sd(sapply(re_120[[7]], "[[", 1)))
v_480<-c(sd(sapply(re_480[[1]], "[[", 1)),sd(sapply(re_480[[4]], "[[", 1)),
        sd(sapply(re_480[[7]], "[[", 1)))
v_1200<-c(sd(sapply(re_1200[[1]], "[[", 1)),sd(sapply(re_1200[[4]], "[[", 1)),
        sd(sapply(re_1200[[7]], "[[", 1)))
v_4800<-c(sd(sapply(re_4800[[1]], "[[", 1)),sd(sapply(re_4800[[4]], "[[", 1)),
        sd(sapply(re_4800[[7]], "[[", 1)))
v_axis<-c(v_40,v_120,v_480,v_1200,v_4800)
var<-matrix(v_axis,nrow = 3,ncol = 5)
var<-t(var)
rownames(var)<-c('40','120','480','1200','4800')
