...
plot.new()
l <- legend(0, 0, bty='n',c("Data generating process", "Disjoint method","Proposed method"),plot=FALSE, pch=1:3,col=1:3)
...
legend(par('usr')[2], par('usr')[4], bty='n', xpd=NA
       ,c("Data generating process", "Disjoint method","Proposed method"), pch=1:3,col=1:3)
