...
df<-data.frame(c('40','120','480','1200','4800'),
               ...
               ,percent(dgp_f,accuracy = 0.01),percent(dj_f,accuracy = 0.01)
               ,percent(qr_f,accuracy = 0.01),percent(cf_f,accuracy = 0.01))
...
kable(df,'latex', booktabs = T,caption = 'Size effect (q=30%)',align = 'c') %>% 
        add_header_above(c(" ", "Percentage profit loss" = 4, "Average service level" = 4
                           , "Fill rate" = 4),bold = T) %>%
