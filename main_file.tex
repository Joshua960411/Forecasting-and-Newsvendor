...
\begin{figure}
\centering
\caption{Performance vs. data size with under-paramaterised linear model}
\begin{subfigure}[b]{0.48\textwidth}
\centering
...
\begin{figure}
\centering
\caption{Performance vs. data size with over-paramaterised linear model}
\begin{subfigure}[b]{0.48\textwidth}
\centering
...
The service levels for these two situations are presented in Figure \ref{fig:mis_under} (b) and Figure \ref{fig:mis_over} (b). The trends of DGP and PM are similar to the ones in Figure \ref{fig:sl0.3}. Yet, one may find the incorrect using of parameters in DJ leads to improvement of SL when sample size is small in both Figures. This can be possibly explain as  Thus, there is a trade-off between PPL and SL when using disjoint method.
...
\begin{figure}
\centering
\caption{Performance vs. data size with under-paramaterised nonlinear model}
\begin{subfigure}[b]{0.48\textwidth}
\centering
...
Figure \ref{fig:misnon_under} represents the scenario where our applied model is \emph{too simple}, merely AR(1) process.
