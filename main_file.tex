...
\begin{table}[ht]
\caption{Size effect at 0.3 target service level for classical NVP with known model}
...
DJ, and our proposed method, PM. As we have shown the QR and PM are equivalent in linear NVP, we don't include QR here.
